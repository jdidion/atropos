...
class Match(object):
    ...
    def wildcards(self, wildcard_char='N'):
        ...
        wildcards = [
            ...
            if (
                self.adapter.sequence[self.astart + i] == wildcard_char and
...
#
# Note: these are currently just prototype implementations. They will need to be
# optimized using numpy and/or re-written in cython.
#
    ...
    def match_insert(self, seq1, seq2):
        ...
        def _match(
            ...
            best_adapter_matches, best_adapter_mismatches = (
                a1_match if a1_prob < a2_prob else a2_match
            )[
                4:6
            ]
            return (
                ...
                Match(
                    ...
                    insert_match_size,
                    len1,
                    best_adapter_matches,
                    best_adapter_mismatches,
                ),
                Match(
                    0,
                    adapter_len2,
